#TODO:
#convert UIDS between hex and string forms
...
$LDAPdisplayname = "Адресная книга CIT"
...
Set-ItemProperty -Path $profile$cit_ldapconfig -Name "000b6615" -Value ([byte[]](0x01,0x0))
...
Set-ItemProperty -Path $profile$cit_ldapconfig -Name "001e67f1" -Value ([byte[]](0x0A))
